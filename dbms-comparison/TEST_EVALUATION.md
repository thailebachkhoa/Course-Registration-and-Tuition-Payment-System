...
| Backup & recovery | `mysql/tests/05_backup_recovery.sql`, `mongo/tests/05_backup_recovery.js`, `scripts/backup.ps1`, `scripts/restore.ps1` | MySQL dump/binlog readiness/checksum; MongoDB archive dump/restore and replica set state | MySQL point-in-time binlog replay is not fully automated |
